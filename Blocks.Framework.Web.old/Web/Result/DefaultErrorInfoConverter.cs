...
namespace Blocks.Web.Models
{
    ...
    {
        private readonly IBlocksWebModuleConfiguration _configuration;
        ...
        public DefaultErrorInfoConverter(
            IBlocksWebModuleConfiguration configuration,
        ...
        private string L(string name)
        {
            try
            {
                return _localizationManager.GetString("BlocksWeb", name);
            }
            catch (Exception)
            {
                return name;
