...
namespace Blocks.Framework.AutoMapper
{
    public static class AutoMapperExtensions
    {
        ...
        public static TDestination AutoMapTo<TDestination>(this object source)
        {
        ...
        /// <returns></returns>
        public static TDestination AutoMapTo<TSource, TDestination>(this TSource source, TDestination destination)
        {
