...
//                effectiveHttpContext = new UrlPrefixAdjustedHttpContext(httpContext, _urlPrefix);
            ...
            if (routeData.RouteHandler is StopRoutingHandler) return routeData;
...
//                new RouteHandler(_workContextAccessor, routeData.RouteHandler, SessionState, _pipeline);
            ...
            if (IsHttpRoute) routeData.Values["IWorkContextAccessor"] = _iocManager; // for WebApi
        ...
        public override VirtualPathData GetVirtualPath(RequestContext requestContext, RouteValueDictionary values)
        {
            ...
            if (values.TryGetValue("httproute", out httpRouteValue))
                if (httpRouteValue is bool && (bool) httpRouteValue != IsHttpRoute) return null;
...
//
//                    if (environment == null) environment = new Dictionary<string, object>();
//
