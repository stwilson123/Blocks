...
namespace System.Linq.Dynamic
{
    public static class DynamicQueryable
    {
        ...
        public static IQueryable<T> Join<T, TInner>(this IQueryable<T> outer, IEnumerable<TInner> inner, string outerSelector, string innerSelector, string resultsSelector, params object[] values)
        {
            var joinResult = Join((IQueryable)outer, (IEnumerable)inner, outerSelector, innerSelector, resultsSelector, values);
            var sql = joinResult.ToString();
            return (IQueryable<T>)joinResult;
        }
