...
//            Logger.InfoFormat("Loading features");
//
//            var result =
//                _parallelCacheContext
...
//                .ToArray();
//
//            Logger.InfoFormat("Done loading features");
//            return result;
//        }
//
...
//                throw new SystemException(T("Error while loading extension '{0}'.", extensionId), ex);
//            }
//
...
//        }
        ...
        private static string GetSourceFeatureNameForType(Type type, string extensionId) {
            foreach (BlocksFeatureAttribute featureAttribute in type.GetCustomAttributes(typeof(BlocksFeatureAttribute), false)) {
