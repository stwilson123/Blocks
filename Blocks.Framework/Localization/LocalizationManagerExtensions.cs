...
namespace Blocks.Framework.Localization
{
    public static class LocalizationManagerExtensions
    {
        ...
        public static string GetString(this ILocalizationManager localizationManager, Abp.Localization.LocalizableString localizableString)
        {
        ...
        /// </summary>
        /// <returns>Localized string</returns>
        public static string GetString(this ILocalizationManager localizationManager, Abp.Localization.LocalizableString localizableString, CultureInfo culture)
        {
