...
{
    public abstract class BlocksTestBase : AbpIntegratedTestBase<BlocksTestModule>
    {
        ...
        protected void UsingDbContext(Action<BlocksDbContext> action)
        {
            UsingDbContext(AbpSession.TenantId, action);
        }

        protected Task UsingDbContextAsync(Func<BlocksDbContext, Task> action)
        {
            return UsingDbContextAsync(AbpSession.TenantId, action);
        }

        protected T UsingDbContext<T>(Func<BlocksDbContext, T> func)
        {
            return UsingDbContext(AbpSession.TenantId, func);
        }

        protected Task<T> UsingDbContextAsync<T>(Func<BlocksDbContext, Task<T>> func)
        {
            return UsingDbContextAsync(AbpSession.TenantId, func);
        }

        protected void UsingDbContext(int? tenantId, Action<BlocksDbContext> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<BlocksDbContext>())
                {
        ...
        protected async Task UsingDbContextAsync(int? tenantId, Func<BlocksDbContext, Task> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<BlocksDbContext>())
        ...
        protected T UsingDbContext<T>(int? tenantId, Func<BlocksDbContext, T> func)
        {
            T result;
        ...
        protected async Task<T> UsingDbContextAsync<T>(int? tenantId, Func<BlocksDbContext, Task<T>> func)
        {
            T result;
