   ...
   public  class ConfigurationManagerWrapper
    {
        ...
        public static Dictionary<string, ConnectionStringSettings> ConnectionStrings =
            new Dictionary<string, ConnectionStringSettings>() {
                ...
                "Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=192.168.1.215)(PORT=1521))(CONNECT_DATA=(SERVICE_NAME=devserver)));User ID=R2E4MOD;Password=R2E4MOD;Pooling=true;Max Pool Size=500;Min Pool Size=0;Persist Security Info=true;Enlist=false",
