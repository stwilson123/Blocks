...
namespace Blocks.Framework.Tools
{
    /// <summary>
    /// 加密解密工具类
    /// </summary>
    public static class CryptTools
    {
        ...
        public static string Encrypt(string content, string secret)
        {
            ...
            byte[] CopyContent = new byte[ContentByte.Length];
            Array.Copy(ContentByte, CopyContent, ContentByte.Length);
            byte[] ContentCryptByte = Crypt(CopyContent, Key);
